...
<section class="container" id="payment-page"
    ...
    <form action="{{ route('payment.process') }}" method="POST">
        ...
        {{-- Kirim data tiket yang tersembunyi --}}
    ...
    <div class="payment-layout">
        ...
        <div class="order-summary">
            ...
            <div class="order-item">
                ...
                <span class="item-value" id="harga_per_tiket_display">Rp {{ number_format($tiket['harga_weekday_raw'], 0, ',', '.') }}</span>
            </div>
            <hr>
            <div class="order-item">
            ...
            <div class="order-item">
                ...
                <div class="quantity-selector">
                    ...
                    <input type="number" name="jumlah_tiket" id="jumlah_tiket" value="1" min="1" class="form-control quantity-input" readonly>
                    <button type="button" id="btn-plus">+</button>
                </div>
            </div>
            <div class="total-summary">
                <span class="total-label">Total Pembayaran</span>
                <span class="total-value" id="total_pembayaran">Rp {{ number_format($tiket['harga_weekday_raw'], 0, ',', '.') }}</span>
            </div>
        </div>
